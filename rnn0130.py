...
spot_data1 = rd.get_price('510050.XSHG', start_date='2014-04-01', end_date='2019-01-29', frequency='1d')
...
# 获取滞后了1天的数据
spot_data2 = rd.get_price('510050.XSHG', start_date='2014-04-02', end_date='2019-01-30', frequency='1d')
